...
public class FCFS {
    public static void main(String[] args) {
        ...
        int p = input.nextInt();
        int[] arrivaltime = new int[p]; int[] bursttime = new int[p];
        int[] ct = new int[p]; int[] tat = new int[p]; int[] wt = new int[p];
        System.out.println("Enter arrival time and burst: ");
        for (int i = 0; i < p; i++) {
        ...
        for (int i = 0; i < p; i++) {
            processes.add(new int[]{arrivaltime[i],bursttime[i],ct[i]});
        }
        ...
        System.out.println("\nArrival Time\tBurst Time\tCompletion Time\tTurnAroundTime\tWaitingTime");
        for (int i = 0; i < processes.size(); i++) {
            System.out.println(processes.get(i)[0] + "\t\t" + processes.get(i)[1] + "\t\t" + processes.get(i)[2]
            + "\t\t" + tat[i] + "\t\t" + wt[i]);
        }
        input.close();
    }
